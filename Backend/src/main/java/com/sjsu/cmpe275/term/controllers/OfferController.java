...
public class OfferController {
	...
	public ResponseEntity<ResponseDTO> postOffer(@RequestBody OfferDto offerDTO) {
		try {
			Offer offer = new Offer(offerDTO.getSourceCountry(), offerDTO.getSourceCurrency(),offerDTO.getAmount(),offerDTO.getAmountInUSD(),offerDTO.getDestinationCountry(),offerDTO.getDestinationCurrency(),offerDTO.getExpirationDate(),offerDTO.getCounterOfferAllowed(),offerDTO.getSplitOfferAllowed());
